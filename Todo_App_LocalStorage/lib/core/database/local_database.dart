...
class LocalDatabase {
  ...
  Future<void> createDatabase() async{
    ...
    database = await openDatabase(path, version: 1, onCreate: (db, version) async
    {
      ...
      await db.execute(
        'CREATE TABLE todos (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT NOT NULL, description TEXT, category TEXT NOT NULL, priority TEXT NOT NULL, dueDate TEXT NOT NULL, dueTime TEXT NOT NULL, completedDate TEXT, completedTime TEXT)',
      );
